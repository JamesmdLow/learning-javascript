...
//Wrapping Up
// const and let are far better replacements for the old var to define variables. Moving forward, we should quit using var and use const where possible and choose let otherwise.
// These two have block scope, prevent accidental redefinition of variables, and offer much better programming safety.
// You also learned how to honor immutability when programming. Next you will learn about improvements in passing arguments to functions.